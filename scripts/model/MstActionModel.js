...
class MstActionModel extends BaseModel {
    constructor() {
        ...
        /** @type {string} 必要項目（配列） */
        this._needCols = null;
        /** @type {number} 必要アイテムid */
        this._needVals = null;
        /** @type {number} 必要アイテム個数 */
        this._needItemId = null;
        /** @type {number} 必要アイテム個数 */
        this._itemNum = null;
        /** @type {string} 説明 */
        this._expl = null;
    ...
    setAllProps(obj) {
        ...
        if (obj.needItemId !== undefined) this.needItemId = obj.needItemId;
        if (obj.itemNum !== undefined) this.itemNum = obj.itemNum;
     ...
     */
    getPropNames() {
        return ['id', 'name', 'type', 'trgtCols', 'efctVals', 'needCols', 'needVals', 'needItemId', 'itemNum', 'expl'];
    }
}
